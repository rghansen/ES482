...
#Plot residuals vs. longitude (shown with smoothing curve)
resid_vs_long_11 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(long, resid_11), shape = 1) +
  geom_smooth(aes(long, resid_11), se = FALSE)

#Plot residuals vs. coll.doy (shown with smoothing curve)
resid_vs_coll.doy_11 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(coll.doy, resid_11), shape = 1) +
  geom_smooth(aes(coll.doy, resid_11), se = FALSE)

#Plot residuals vs. sal.length (shown with smoothing curve)
resid_vs_sal.length_11 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(sal.length, resid_11), shape = 1) +
  geom_smooth(aes(sal.length, resid_11), se = FALSE)

grid.arrange(resid_vs_long_11, resid_vs_coll.doy_11, resid_vs_sal.length_11, nrow = 2)
...
#Plot residuals vs. longitude (shown with smoothing curve)
resid_vs_long_6 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(long, resid_6), shape = 1) +
  geom_smooth(aes(long, resid_6), se = FALSE)

#Plot residuals vs. coll.doy (shown with smoothing curve)
resid_vs_coll.doy_6 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(coll.doy, resid_6), shape = 1) +
  geom_smooth(aes(coll.doy, resid_6), se = FALSE)
...
grid.arrange(resid_vs_long_6, resid_vs_coll.doy_6, resid_vs_sal.length_6, nrow = 2)
...
#Call coeﬃcient estimates for random  effects
ranef(model_11)
...
ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(lat, oto.width), shape = 1, size = 0.2) +
  geom_line(aes(lat, fit_11_pop)) + 
  geom_point(aes(lat, fit_11_sal.id, group = sal.id), shape = 2)

#plot model with salmon length
ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(sal.length, oto.width), shape = 1, size = 0.2) +
  geom_line(aes(sal.length, fit_11_pop)) + 
  geom_point(aes(sal.length, fit_11_sal.id, group = sal.id), shape = 2)

#plot model with collection day
ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(coll.doy, oto.width), shape = 1, size = 0.2) +
  geom_line(aes(coll.doy, fit_11_pop)) + 
  geom_point(aes(coll.doy, fit_11_sal.id, group = sal.id), shape = 2)

grid.arrange(model_vs_long_11, model_vs_coll.doy_11, model_vs_sal.length)
