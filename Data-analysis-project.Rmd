...
ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(long, oto.width), shape = 1) +
  geom_smooth(aes(long, oto.width), se = FALSE) +
  xlab("Longitude [°]") +
...
ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(coll.doy, oto.width), shape = 1) +
  geom_smooth(aes(coll.doy, oto.width), se = FALSE) +
  xlab("Collection of day") +
  ylab("Otolith width [mm]")

#Otolith width vs. sal.length
ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(sal.length, oto.width), shape = 1) +
  geom_smooth(aes(sal.length, oto.width), se = FALSE) +
