...
- 
- Non-independence from repeated measurements of multiple herring that occurred within the same salmon stomach/experimental unit. It is likely that similar sized herring will occur in the same school targeted by a salmon.
...
#Collection day of year
hist(herring_data$coll.doy, col = grey(0.9), main = "Histogram of day of year", xlab = "Collection day of year")
