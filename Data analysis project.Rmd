...
plot(herring_data$coll.doy, herring_data$oto.width_standardized, type = "h", main = "Otolith width vs. collection day of year", cex.main = 1, font.main = 1, xlab = "Collection day of year") 
...
##D)
Two non-stats papers supporting statements above.
