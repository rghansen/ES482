...
herring_data <- data.frame(sal.id = herring$FishCode,
                           ...
                           stat_area = herring$StatArea)

#Look at what fishing areas are in dataset
sort(unique(herring_data$stat_area))

#Filter only data from Vancouver Island region
herring_data <- herring_data %>% filter(stat_area != 1 | stat_area != 23 | stat_area != 25 | stat_area != 101 | stat_area != 125)
```
