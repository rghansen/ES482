...
#Salmon length
hist(herring_data$sal.length, col = grey(0.9), breaks = seq(0, 100, by = 2), main = "Histogram of salmon length", xlab = "Salmon length")
...
##B)
- Outliers - no outliers observed in the explanatory variables plotted above.
