...
#Plot residuals vs. lat (shown with smoothing curve)
resid_vs_lat_11 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(lat, resid_11), shape = 1) +
  geom_smooth(aes(lat, resid_11), se = FALSE)
...
resid_vs_lat_6 <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(lat, resid_6), shape = 1) +
  geom_smooth(aes(lat, resid_6), se = FALSE)
...
grid.arrange(resid_vs_lat_6, resid_vs_sal.length_6, nrow = 2)
