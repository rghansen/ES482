...
with(herring_data, plot(oto.width, row, las = 1, type = "n", cex.lab = 1, cex.axis = 1, xlab = "Otolith width [mm]", ylab = "Row Number"))
...
hist(herring_data$oto.width, cex.main = 1.5, cex.lab = 1, cex.axis = 1, xlim = c(0.3, 2.8), breaks = seq(0.2, 2.8, by = 0.05), col = grey(0.9), main = "Histogram of otolith width", xlab = "Otolith width [mm]")
