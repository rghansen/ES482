...
1. oto width ~ doy + lat + length + (1 | sal.id)  + interaction terms

2. oto width ~ doy + long + length + (1 | sal.id) + interaction terms


oto width ~ length + (1 | sal.id)  + doy*lat
oto width ~ length + (1 | sal.id)  + doy*long
oto width ~ long + (1 | sal.id)  + doy*length
oto width ~ doy + (1 | sal.id)  + lat*length
oto width ~ doy + (1 | sal.id)  + long*length
