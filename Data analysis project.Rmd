...
```{r}
#Create column of standardized otolith widths
...
lat_vs_long <- ggplot(herring_data) +
  theme_minimal() + 
  geom_point(aes(long, lat, colour = sign, size = abs(oto.width_standardized), shape = sign)) + scale_colour_manual( values = c("1" = "darkorange", "-1" = "steelblue4", "0" = "black")) + scale_shape_manual(values = c("1" = 1, "-1" = 1, "0" = 19)) + 
  coord_fixed() +
  ggtitle("Looking for Spatial Autocorrelation in oto.width")
print(lat_vs_long)
```
