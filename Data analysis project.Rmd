...
```{r}
#Plot one-v model residuals
par(mfrow = c(2,2))
plot(resid(model_1) ~ predict(model_1))
plot(resid(model_2) ~ predict(model_2))
plot(resid(model_3) ~ predict(model_3))
plot(resid(model_4) ~ predict(model_4))

#Plot two-v model residuals
par(mfrow = c(3,2))
plot(resid(model_5) ~ predict(model_5))
plot(resid(model_6) ~ predict(model_6))
plot(resid(model_7) ~ predict(model_7))
plot(resid(model_8) ~ predict(model_8))
plot(resid(model_9) ~ predict(model_9))

#Plot three-v model with residuals
par(mfrow = c(1,2))
plot(resid(model_10) ~ predict(model_10))
plot(resid(model_11) ~ predict(model_11))


#Plot two-v interaction model with residuals
par(mfrow = c(3,2))
plot(resid(model_5i) ~ predict(model_5i))
plot(resid(model_6i) ~ predict(model_6i))
plot(resid(model_7i) ~ predict(model_7i))
plot(resid(model_8i) ~ predict(model_8i))
plot(resid(model_9i) ~ predict(model_9i))

#Plot three-v model with residuals
par(mfrow = c(3,2))
plot(resid(model_10cl) ~ predict(model_10cl))
plot(resid(model_11cl) ~ predict(model_11cl))
plot(resid(model_10l) ~ predict(model_10l))
plot(resid(model_11l) ~ predict(model_11l))
plot(resid(model_10c) ~ predict(model_10c))
plot(resid(model_11c) ~ predict(model_11c))
```
