...
oto.width_vs_long_data_11 <- data.frame(long = seq(-125.29, -123.16, 0.001), coll.doy = median(herring_data$coll.doy), sal.length = median(herring_data$sal.length))
...
oto.width_vs_long_data_11$coll.doy_standardized <- (oto.width_vs_long_data_11$coll.doy - mean(oto.width_vs_long_data_11$coll.doy)/sd(oto.width_vs_long_data_11$coll.doy))

#Add standardized sal.length to data frame
oto.width_vs_long_data_11$sal.length_standardized <- (oto.width_vs_long_data_11$sal.length - mean(oto.width_vs_long_data_11$sal.length)/sd(oto.width_vs_long_data_11$sal.length))
...
model_vs_long_plot_11 <- ggplot(herring_data) +
  theme_minimal() + 
...
>>>>>>> 737eea0c410a5f508b11479d57c6132a02170cf0
```
