...
### A)
```{r, echo = TRUE, fig.width = 6, fig.height = 5, echo = FALSE}
...
```{r}
#Call coeﬃcient estimates for fixed effects of Model 11 and Model 6
fixef(model_11)
fixef(model_6)

#Call variation within and between the random effect (salmon ID) of Model 11 and Model 6
VarCorr(model_11)
VarCorr(model_6)
```

```{r, fig.width = 10, fig.height = 8, echo = FALSE}
#Calculate conﬁdence intervals for coeﬃcient estimates of Model 11 and Model 6
confint(model_11)
confint(model_6)
